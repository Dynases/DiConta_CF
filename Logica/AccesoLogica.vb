...
#Region "COMPROBANTE"
    ...
    Public Shared Function L_prCargarComboBanco() As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prCargarBanco() As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prComprobanteGrabarIntegracion(ByRef _numi As String, _numDoc As String, _tipo As String, _anio As String, _mes As String, _num As String, _fecha As String, _tipoCambio As String, _glosa As String, _obs As String, _numiEmpresa As String, _detalle As DataTable, _detalle2 As DataTable, _ifnumi As String, _ifto001numi As Integer, _iftc As Double,
        ...
        Return _resultado
    End Function
    Public Shared Function L_prComprobanteGrabarIntegracionBanco(ByRef _numi As String, _numDoc As String, _anio As String, _mes As String, _num As String, _fecha As String, _tipoCambio As String,
                                                              _numiEmpresa As String, _detalle2 As DataTable, _ifnumi As String, _ifto001numi As Integer, _iftc As Double,
                                                            _iffechai As String, _iffechaf As String, _ifest As Integer,
                                                          fechai As String, fechaf As String) As Boolean
        Dim _resultado As Boolean
        ...
        _listParam.Add(New Datos.DParametro("@iffechaf", _iffechaf))
        _listParam.Add(New Datos.DParametro("@ifest", _ifest))
        _listParam.Add(New Datos.DParametro("@ifsuc", 1))
        _listParam.Add(New Datos.DParametro("@fechaI", fechai))
        _listParam.Add(New Datos.DParametro("@fechaF", fechaf))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TI005", _listParam)
...
#Region "COMPROBANTES MARCOS"
    ...
    Public Shared Function L_prIntegracionGeneral() As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prIntegracionGeneralBanco() As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prObtenerTotalesTransaccionVentaContado(tipo As Integer, factura As Integer, fechai As String, fechaf As String) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prObtenerTotalesConciliacion(fechai As String) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 59))
        _listParam.Add(New Datos.DParametro("@seuact", L_Usuario))
        _listParam.Add(New Datos.DParametro("@fechaI", fechai))
        _Tabla = D_ProcedimientoConParam("sp_Mam_Asiento", _listParam)
        Return _Tabla
    ...
    Public Shared Function L_prObtenerTotalesContado(fechai As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prObtenerTotalesContadoIntegracionBanco(fechai As String) As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prObtenerTotalesConciliacionIntegracionBanco(fechai As String) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 67))
        _listParam.Add(New Datos.DParametro("@seuact", L_Usuario))
        _listParam.Add(New Datos.DParametro("@fechaI", fechai))
        _Tabla = D_ProcedimientoConParam("sp_Mam_Asiento", _listParam)
        Return _Tabla
    ...
    Public Shared Function L_prObtenerIdCaja(fechai As String) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prObtenerTotalesCredito(fechai As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prObtenerPagosTotalesCuentaPorCobrar(fechai As String, fechaf As String) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prObtenerTotalesBanco(fechai As String) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 62))
        _listParam.Add(New Datos.DParametro("@seuact", L_Usuario))
        _listParam.Add(New Datos.DParametro("@fechaI", fechai))
        _Tabla = D_ProcedimientoConParam("sp_Mam_Asiento", _listParam)
        Return _Tabla
    ...
    Public Shared Function L_prListarClienteCredito(fechai As String, fechaf As String) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prListarClienteCredito2(fechai As String, fechaf As String) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 63))
        _listParam.Add(New Datos.DParametro("@seuact", L_Usuario))
        _listParam.Add(New Datos.DParametro("@fechaI", fechai))
        _listParam.Add(New Datos.DParametro("@fechaF", fechaf))
        _Tabla = D_ProcedimientoConParam("sp_Mam_Asiento", _listParam)
