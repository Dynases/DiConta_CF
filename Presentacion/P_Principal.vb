...
#Region "Metodos Privados"
    ...
    Private Sub _prIniciarTodo()
        ...
        L_prAbrirConexionBitacora(gs_Ip, gs_UsuarioSql, gs_ClaveSql, "BHDiconCF20")
...
#End Region
    ...
    Private Sub btVentCierreCaja2_Click(sender As Object, e As EventArgs) Handles btVentCierreCaja2.Click
        SideNav1.IsMenuExpanded = False
        Ventana.Select()
        Dim frm As New F1_AsientosContables2
        frm._nameButton = btVentCierreCaja2.Name
        frm._modulo = FP_Ventas
        Dim tab3 As SuperTabItem = superTabControl3.CreateTab(frm.Text)
        frm._tab = tab3
        Dim panel As Panel = P_Global._fnCrearPanelVentanas(frm)
    ...
    Private Sub btVentCierreCaja3_Click(sender As Object, e As EventArgs) Handles btVentCierreCaja3.Click
        SideNav1.IsMenuExpanded = False
        Ventana.Select()
        Dim frm As New F1_AsientoContableBanco
        frm._nameButton = btVentCierreCaja3.Name
        frm._modulo = FP_Ventas
        Dim tab3 As SuperTabItem = superTabControl3.CreateTab(frm.Text)
        frm._tab = tab3
        Dim panel As Panel = P_Global._fnCrearPanelVentanas(frm)
